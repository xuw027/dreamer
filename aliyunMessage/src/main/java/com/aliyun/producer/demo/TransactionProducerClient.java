...
public class TransactionProducerClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        properties.put(PropertyKeyConst.ProducerId, properties.getProperty("ProducerId")); // ProducerId需要设置您自己的
        properties.put(PropertyKeyConst.AccessKey, properties.getProperty("AccessKey")); // AccessKey 需要设置您自己的
        properties.put(PropertyKeyConst.SecretKey, properties.getProperty("SecretKey")); // SecretKey 需要设置您自己的
